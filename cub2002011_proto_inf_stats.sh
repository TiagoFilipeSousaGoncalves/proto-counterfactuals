...
echo "CUB2002011 | ProtoPNet"
    python code/protopnet/prototypes_inference_stats.py --checkpoint cub2002011/protopnet/densenet121/2023-01-06_12-07-43/
    # python code/protopnet/prototypes_inference_stats.py --checkpoint cub2002011/protopnet/densenet161/XXX/
    python code/protopnet/prototypes_inference_stats.py --checkpoint cub2002011/protopnet/resnet34/2022-12-29_19-34-24/
    # python code/protopnet/prototypes_inference_stats.py --checkpoint cub2002011/protopnet/resnet152/XXX/
    python code/protopnet/prototypes_inference_stats.py --checkpoint cub2002011/protopnet/vgg16/2022-12-30_22-45-59/
    # python code/protopnet/prototypes_inference_stats.py --checkpoint cub2002011/protopnet/vgg19/XXX/
elif [ $model == 'dppnet' ]
then
