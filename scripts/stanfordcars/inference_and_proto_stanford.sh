...
# python code/models_inference_and_prototypes.py --dataset STANFORDCARS --base_architecture densenet121 --num_workers 2 --gpu_id 0 --checkpoint stanfordcars/densenet121/2022-10-24_08-55-48/
