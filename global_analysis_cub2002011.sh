...
python code/models_global_analysis.py --dataset CUB2002011 --base_architecture densenet121 --batchsize 32 --num_workers 2 --gpu_id 0 --checkpoint cub2002011/densenet121/2022-09-14_06-32-51/
