...
then
    ...
    python code/protopnet/models_counterfactuals_retrieval.py --dataset PAPILA --base_architecture densenet121 --num_workers 0 --gpu_id 0 --checkpoint papila/protopnet/densenet121/2022-12-23_11-33-39/ --generate_img_features
    # python code/protopnet/models_counterfactuals_retrieval.py --dataset PAPILA --base_architecture densenet161 --num_workers 0 --gpu_id 0 --checkpoint papila/protopnet/densenet161/XXX/ --generate_img_features
    python code/protopnet/models_counterfactuals_retrieval.py --dataset PAPILA --base_architecture resnet34 --num_workers 0 --gpu_id 0 --checkpoint papila/protopnet/resnet34/2022-12-23_18-42-05/ --generate_img_features
    # python code/protopnet/models_counterfactuals_retrieval.py --dataset PAPILA --base_architecture resnet152 --num_workers 0 --gpu_id 0 --checkpoint papila/protopnet/resnet152/XXX/ --generate_img_features
    python code/protopnet/models_counterfactuals_retrieval.py --dataset PAPILA --base_architecture vgg16 --num_workers 0 --gpu_id 0 --checkpoint papila/protopnet/vgg16/2022-12-23_18-10-15/ --generate_img_features
    # python code/protopnet/models_counterfactuals_retrieval.py --dataset PAPILA --base_architecture vgg19 --num_workers 0 --gpu_id 0 --checkpoint papila/protopnet/vgg19/XXX/ --generate_img_features
elif [ $model == 'dppnet' ]
then
