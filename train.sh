...
python code/models_train.py --dataset CUB2002011 --base_architecture densenet121 --batchsize 16 --num_workers 3 --gpu_id 0
python code/models_train.py --dataset CUB2002011 --base_architecture densenet161 --batchsize 16 --num_workers 3 --gpu_id 0
python code/models_train.py --dataset CUB2002011 --base_architecture resnet34 --batchsize 16 --num_workers 3 --gpu_id 0
python code/models_train.py --dataset CUB2002011 --base_architecture resnet152 --batchsize 16 --num_workers 3 --gpu_id 0
