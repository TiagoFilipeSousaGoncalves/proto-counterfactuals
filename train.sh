...
# python code/models_train.py --dataset CUB2002011 --base_architecture densenet161 --batchsize 32 --num_workers 3 --gpu_id 0
...
# python code/models_train.py --dataset CUB2002011 --base_architecture vgg16 --batchsize 32 --num_workers 3 --gpu_id 0
# python code/models_train.py --dataset CUB2002011 --base_architecture vgg19 --batchsize 32 --num_workers 3 --gpu_id 0
...
python code/models_train.py --dataset STANFORDCARS --base_architecture densenet161 --batchsize 32 --num_workers 3 --gpu_id 0
...
python code/models_train.py --dataset STANFORDCARS --base_architecture vgg16 --batchsize 32 --num_workers 3 --gpu_id 0
python code/models_train.py --dataset STANFORDCARS --base_architecture vgg19 --batchsize 32 --num_workers 3 --gpu_id 0
