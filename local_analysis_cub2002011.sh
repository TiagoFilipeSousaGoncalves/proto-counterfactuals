...
echo "STARTED | CUB2002011 | LOCAL ANALYSIS"
...
python code/models_local_analysis.py --dataset CUB2002011 --base_architecture resnet152 --batchsize 16 --num_workers 0 --gpu_id 0 --checkpoint cub2002011/resnet152/
