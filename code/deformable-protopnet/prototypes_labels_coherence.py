...
if os.path.exists(os.path.join("results", DATASET.lower(), "deformable-protopnet", "prototype_label_coherence.txt")):
    os.remove(os.path.join("results", DATASET.lower(), "deformable-protopnet", "prototype_label_coherence.txt"))

report = open(os.path.join("results", DATASET.lower(), "deformable-protopnet", "prototype_label_coherence.txt"), "at")
