...
if __name__ == "__main__":
    ...
    for dataset in ("CUB2002011", "PAPILA", "PH2", "STANFORDCARS"):
        ...
        if dataset == "CUB2002011":
            ...
            train_aug_set = CUB2002011Dataset(
                data_path=os.path.join(DATA_DIR, "cub2002011", "processed_data", "train", "cropped"),
                classes_txt=os.path.join(DATA_DIR, "cub2002011", "source_data", "classes.txt"),
                augmented=True
            )
        ...
        # STANFORDCARS
            ...
            # Training with Data Augmentation
            train_aug_set = STANFORDCARSDataset(
                data_path=DATA_DIR,
                cars_subset="cars_train",
                augmented=True,
                cropped=True
        ...
        print(f"Training with Data Augmentation: {len(train_aug_set)}")
