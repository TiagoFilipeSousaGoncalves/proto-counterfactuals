...
# Train Transforms (Do not normalize)
train_transforms = torchvision.transforms.Compose([
    torchvision.transforms.Resize((IMG_SIZE, IMG_SIZE)),
    torchvision.transforms.ToTensor(),
])

# Test Transforms (Do not normalize)
...
# Test
test_loader = torch.utils.data.DataLoader(dataset=test_set, batch_size=BATCH_SIZE, shuffle=True, num_workers=WORKERS, pin_memory=False)
...
root_dir_for_saving_test_images = os.path.join(weights_dir, f'K{K}_nearest_test')
