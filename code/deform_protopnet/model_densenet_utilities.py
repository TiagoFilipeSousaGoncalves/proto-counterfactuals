...
class _DenseLayer(nn.Sequential):
    ...
    # Method: Information of the Layer Convolution
...
class _DenseBlock(nn.Sequential):
    ...
    # Method: Get Conv-Block Information
...
def densenet121_features(pretrained=False, **kwargs):
    ...
    # '.'s are no longer allowed in module names, but pervious _DenseLayer has keys 'norm.1', 'relu.1', 'conv.1', 'norm.2', 'relu.2', 'conv.2'.
