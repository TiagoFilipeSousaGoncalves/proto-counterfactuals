...
# python code/models_inference_and_prototypes.py --dataset CUB2002011 --base_architecture resnet152 --batchsize 16 --num_workers 3 --gpu_id 0 --checkpoint cub2002011/resnet152/
python code/models_inference_and_prototypes.py --dataset CUB2002011 --base_architecture vgg16 --batchsize 16 --num_workers 2 --gpu_id 0 --checkpoint cub2002011/vgg16/2022-10-14_21-14-35/
python code/models_inference_and_prototypes.py --dataset CUB2002011 --base_architecture vgg19 --batchsize 16 --num_workers 2 --gpu_id 0 --checkpoint cub2002011/vgg19/2022-10-17_08-13-40/
