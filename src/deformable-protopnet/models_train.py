...
if __name__ == "__main__":
    ...
    for fold in args.folds:
        ...
        results_dir = os.path.join(OUTPUT_DIR, DATASET.lower(), "deformable-protopnet", BASE_ARCHITECTURE.lower(), timestamp, f"fold_{fold}")
        ...
        joint_optimizer_specs = [
            {'params': ppnet_model.features.parameters(), 'lr': JOINT_OPTIMIZER_LRS['features'], 'weight_decay': 1e-3},
        ...
        for epoch in range(init_epoch, NUM_TRAIN_EPOCHS):
            ...
            if epoch >= PUSH_START and epoch in PUSH_EPOCHS:
                ...
                push_prototypes(
                    ...
                    root_dir_for_saving_prototypes=saved_prototypes_dir,
                    epoch_number=None,
