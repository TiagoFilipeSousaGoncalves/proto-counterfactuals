...
python code/models_test.py --dataset CUB2002011 --base_architecture densenet121 --batchsize 32 --num_workers 2 --gpu_id 0 --checkpoint cub2002011/densenet121/2022-09-14_06-32-51/
python code/models_test.py --dataset CUB2002011 --base_architecture densenet161 --batchsize 32 --num_workers 2 --gpu_id 0 --checkpoint cub2002011/densenet161/2022-09-15_16-14-45/
python code/models_test.py --dataset CUB2002011 --base_architecture resnet34 --batchsize 32 --num_workers 2 --gpu_id 0 --checkpoint cub2002011/resnet34/2022-09-17_17-03-33/
